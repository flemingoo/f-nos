...
{
	{ 1, 5, 1, 4,  false, false, true },  // task1 parameters
	{ 2, 6,  2, 5,  false, false, true },  // task2 parameters
	{ 3, 15, 3, 12, false, false, true },   // task3 parameters
	{ 3, 10, 3, 8, false, false, true }   // task4 parameters
};
...
void OS_Sched(void)
{
		...
		for (;T0TC <= hp;)
		{
			...
			else if((Task[3].releaseFlag == true) && (Task[3].runningFlag == false))
			{
				IO0CLR=0x0F;
				task4();
			}
